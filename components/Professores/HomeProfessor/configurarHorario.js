...
export default function ConfigurarHorario({ navigation, route }) {
    ...
    function renderHorario(){
        if(horarios){
            return < Text style={{marginTop:20,fontWeight:'bold'}} > Horario configurado para: Abertura: {horarios.horasAbertura}Hrs -  Fechamento: {horarios.horasFechamento}Hrs </Text>
        } return null
    }
